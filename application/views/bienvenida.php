		...
		<!-- Header -->
			<header id="header" class="alt">
				<div class="logo"><a href="<?=base_url();?>">Wather <span>Guardians</span></a></div>
				<a href="#menu">Menu</a>
			</header>
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<header>
						<h1>Wather <span>Guardians</span></h1>
							...
							<!-- 2 Columns -->
								<div class="flex flex-2">
									...
									<div class="col col2">
										...
										<p>Implementar la gestion integrada de los recursos hídricos a nivel local recopilando información sobre el seguimiento de los recursos identificados en el tiempo para conocer como los niveles de agua han cambiado con el tiempo y como predecir y gestionar los recursos hídricos para los siguientes años.</p>
